...
import (
	api "github.com/metanonia/prolog/api/v1"
	"github.com/metanonia/prolog/internal/config"
	"github.com/metanonia/prolog/internal/loadbalance"
...
// 원서 google.golang.org/grpc v1.32.0 과는 달리
// v1.47.0 에서는 error 리턴값을 가진다
